...
//      Log.d("PlaybackService", "AAA: $mediaItem")
//      if (mediaItem.mediaId.isNotEmpty()) {
//        Log.d("PlaybackService", "BBB: mediaId: ${mediaItem.mediaId}")
//        playlist.add(mediaItem)
//      } else if (mediaItem.requestMetadata.searchQuery != null) {
//        Log.d("PlaybackService", "CCC: searchQuery: ${mediaItem.requestMetadata.searchQuery}")
//        playlist.addAll(MediaItemTree.search(mediaItem.requestMetadata.searchQuery!!))
//      }
//      Log.d("PlaybackService", "DDD: playlist: $playlist")
    }
    return playlist
  }
